...
FAQ_MAP = {
    # ── About the bot ──
    r'(انت مين|انتو مين|انتا مين|مين انت|ايه الموقع|ايه التطبيق|بتعمل (ايه|اى|اي)|ايه وظيفتك|انت عباره عن|انت عبارة عن|انت (ايه|اى|اي)|انتا (ايه|اى|اي)|ايه انت|اي انت|اى انت|هو انت (ايه|اى|اي)|انت بوت|انت روبوت|انت ذكاء اصطناعي|what are you|who are you)':
